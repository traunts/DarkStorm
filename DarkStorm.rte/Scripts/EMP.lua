function Create(self)
	...
	for actor in MovableMan.Actors do
		...
		if dist <= self.disruptRange and actor.PresetName ~= "D2-E Tengu Bushi" and actor.PresetName ~= "D4-E Oni Bushi" and actor.PresetName ~= "D45Shishi" and actor.PresetName ~= "D45Shishi Constructor Top" and actor.PresetName ~= "D45Shishi Constructor Segment" and actor.PresetName ~= "D45Shishi Constructor" then
