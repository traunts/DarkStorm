function InitializeKeys()
	...
	if
		PlayerOneDarkStormSecondaryFire == nil
		or PlayerTwoDarkStormSecondaryFire == nil
		or PlayerThreeDarkStormSecondaryFire == nil
		or PlayerFourDarkStormSecondaryFire == nil
		or PlayerOneDarkStormMelee == nil
		or PlayerTwoDarkStormMelee == nil
		or PlayerThreeDarkStormMelee == nil
		or PlayerFourDarkStormMelee == nil
	then
		--set up I/O
		local io = require("io")
