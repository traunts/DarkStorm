function Create(self)
	...
	if userID ~= 255 then
		...
		if user:IsActor() then
			...
			if user.PresetName ~= "D4 Oni Bushi" and user.PresetName ~= "D4-E Oni Bushi" and user.PresetName ~= "D4-F Oni Bushi" and user.PresetName ~= "D4-C Oni Bushi" then
				...
				for i = 0, MovableMan:GetMOIDCount() do
					if MovableMan:GetRootMOID(i) == user.ID then
						...
						if (object.PresetName == "D52GrenadeMachineGun HE Pack" or object.PresetName == "D52GrenadeMachineGun EMP Pack" or object.PresetName == "D52GrenadeMachineGun Incendiary Pack") and object.Scale == 1 then
							canFire = true;
							break;
						end
					end
