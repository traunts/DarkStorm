					...
					for i = 0, MovableMan:GetMOIDCount() do
						if MovableMan:GetRootMOID(i) == user.ID then
							...
							if object.PresetName == "D75 Cryo Gun Indicator Green" then
								object.Scale = 1;
							elseif object.PresetName == "D75 Cryo Gun Indicator Yellow" or object.PresetName == "D75 Cryo Gun Indicator Red" or object.PresetName == "D75 Cryo Gun Indicator Blue" then
								object.Scale = 0;
							end
						end
					end
								...
								for i = 0, MovableMan:GetMOIDCount() do
									if MovableMan:GetRootMOID(i) == user.ID then
										...
										if object.PresetName == "D75 Cryo Gun Indicator Blue" then
											object.Scale = 1;
										elseif object.PresetName == "D75 Cryo Gun Indicator Green" or object.PresetName == "D75 Cryo Gun Indicator Yellow" or object.PresetName == "D75 Cryo Gun Indicator Red" then
											object.Scale = 0;
										end
									end
								end
									...
									for i = 0, MovableMan:GetMOIDCount() do
										if MovableMan:GetRootMOID(i) == user.ID then
											...
											if object.PresetName == "D75 Cryo Gun Indicator Red" then
												object.Scale = 1;
											elseif object.PresetName == "D75 Cryo Gun Indicator Green" or object.PresetName == "D75 Cryo Gun Indicator Yellow" or object.PresetName == "D75 Cryo Gun Indicator Blue" then
												object.Scale = 0;
											end
										end
									end
									...
									for i = 0, MovableMan:GetMOIDCount() do
										if MovableMan:GetRootMOID(i) == user.ID then
											...
											if object.PresetName == "D75 Cryo Gun Indicator Yellow" then
												object.Scale = 1;
											elseif object.PresetName == "D75 Cryo Gun Indicator Green" or object.PresetName == "D75 Cryo Gun Indicator Red" or object.PresetName == "D75 Cryo Gun Indicator Blue" then
												object.Scale = 0;
											end
										end
									end
