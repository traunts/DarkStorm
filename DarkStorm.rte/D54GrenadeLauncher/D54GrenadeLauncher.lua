					...
					for i = 0, MovableMan:GetMOIDCount() do
						if MovableMan:GetRootMOID(i) == user.ID then
							...
							if object.PresetName == "D54 Grenade Launcher Indicator Green" then
								object.Scale = 1;
							elseif object.PresetName == "D54 Grenade Launcher Indicator Blue" or object.PresetName == "D54 Grenade Launcher Indicator Red" then
								object.Scale = 0;
							end
						end
					end
							...
							for i = 0, MovableMan:GetMOIDCount() do
								if MovableMan:GetRootMOID(i) == user.ID then
									...
									if object.PresetName == "D54 Grenade Launcher Indicator Blue" then
										object.Scale = 1;
									elseif object.PresetName == "D54 Grenade Launcher Indicator Green" or object.PresetName == "D54 Grenade Launcher Indicator Red" then
										object.Scale = 0;
									end
								end
							end
							...
							for i = 0, MovableMan:GetMOIDCount() do
								if MovableMan:GetRootMOID(i) == user.ID then
									...
									if object.PresetName == "D54 Grenade Launcher Indicator Red" then
										object.Scale = 1;
									elseif object.PresetName == "D54 Grenade Launcher Indicator Green" or object.PresetName == "D54 Grenade Launcher Indicator Blue" then
										object.Scale = 0;
									end
								end
							end
