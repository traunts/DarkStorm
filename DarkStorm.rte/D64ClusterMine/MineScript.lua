...
function Update(self)
	...
	if targetID ~= 255 and MovableMan:GetMOFromID(targetID).PresetName ~= "D64ClusterMine Mine" and MovableMan:GetMOFromID(MovableMan:GetRootMOID(targetID)):IsActor() then
		self:GibThis();
	end
