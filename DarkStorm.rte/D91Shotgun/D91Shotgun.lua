					...
					for i = 0, MovableMan:GetMOIDCount() do
						if MovableMan:GetRootMOID(i) == user.ID then
							...
							if object.PresetName == "D91 Shotgun Indicator Green" then
								object.Scale = 1
							elseif
								object.PresetName == "D91 Shotgun Indicator Yellow"
								or object.PresetName == "D91 Shotgun Indicator Red"
								or object.PresetName == "D91 Shotgun Indicator Blue"
							then
								object.Scale = 0
							end
						end
								...
								for i = 0, MovableMan:GetMOIDCount() do
									if MovableMan:GetRootMOID(i) == user.ID then
										...
										if object.PresetName == "D91 Shotgun Indicator Blue" then
											object.Scale = 1
										elseif
											object.PresetName == "D91 Shotgun Indicator Green"
											or object.PresetName == "D91 Shotgun Indicator Yellow"
											or object.PresetName == "D91 Shotgun Indicator Red"
										then
											object.Scale = 0
										end
