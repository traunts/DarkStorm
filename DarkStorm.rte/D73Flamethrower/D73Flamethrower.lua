					...
					for i = 0, MovableMan:GetMOIDCount() do
						if MovableMan:GetRootMOID(i) == user.ID then
							...
							if object.PresetName == "D73 Flamethrower Indicator Green" then
								object.Scale = 1
							elseif
								object.PresetName == "D73 Flamethrower Indicator Yellow"
								or object.PresetName == "D73 Flamethrower Indicator Red"
								or object.PresetName == "D73 Flamethrower Indicator Blue"
							then
								object.Scale = 0
							end
						end
								...
								for i = 0, MovableMan:GetMOIDCount() do
									if MovableMan:GetRootMOID(i) == user.ID then
										...
										if object.PresetName == "D73 Flamethrower Indicator Blue" then
											object.Scale = 1
										elseif
											object.PresetName == "D73 Flamethrower Indicator Green"
											or object.PresetName == "D73 Flamethrower Indicator Yellow"
											or object.PresetName == "D73 Flamethrower Indicator Red"
										then
											object.Scale = 0
										end
