					...
					for i = 0, MovableMan:GetMOIDCount() do
						if MovableMan:GetRootMOID(i) == user.ID then
							...
							if object.PresetName == "D56 Missile Launcher Indicator Green" then
								object.Scale = 1
							elseif
								object.PresetName == "D56 Missile Launcher Indicator Blue"
								or object.PresetName == "D56 Missile Launcher Indicator Red"
							then
								object.Scale = 0
							end
						end
						...
						if MovableMan:ValidMO(fired) then
							...
							for i = 0, MovableMan:GetMOIDCount() do
								if MovableMan:GetRootMOID(i) == user.ID then
									...
									if object.PresetName == "D56 Missile Launcher Indicator Blue" then
										object.Scale = 1
									elseif
										object.PresetName == "D56 Missile Launcher Indicator Green"
										or object.PresetName == "D56 Missile Launcher Indicator Red"
									then
										object.Scale = 0
									end
							...
							for i = 0, MovableMan:GetMOIDCount() do
								if MovableMan:GetRootMOID(i) == user.ID then
									...
									elseif
										object.PresetName == "D56 Missile Launcher Indicator Green"
										or object.PresetName == "D56 Missile Launcher Indicator Blue"
									then
										object.Scale = 0
									end
								end
